...
namespace pb
{
	...
	public:
		...
		void Draw(std::shared_ptr<Texture> texture, const Rect& source, const Transform& transform, const Vector2& scale = Vector2{1, 1}, const Vector2& registration = Vector2{0.5f,0.5f});
